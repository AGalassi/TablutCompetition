...
public class GameModernTablut implements Game {
	...
	private State checkCaptureWhite(State state, Action a)
	{
		...
		if((a.getRowTo()==0 && a.getColumnTo()==0) || (a.getRowTo()==8 && a.getColumnTo()==0) || (a.getColumnTo()==8 && a.getRowTo()==0) || (a.getColumnTo()==8 && a.getRowTo()==8))
		{
	...
	private State checkCaptureBlack(State state, Action a)
	{
		...
		if(a.getColumnTo()<state.getBoard().length-2 && (state.getPawn(a.getRowTo(), a.getColumnTo()+1).equalsPawn("W")||state.getPawn(a.getRowTo(), a.getColumnTo()+1).equalsPawn("K")) && (state.getPawn(a.getRowTo(), a.getColumnTo()+2).equalsPawn("B")||state.getPawn(a.getRowTo(), a.getColumnTo()+2).equalsPawn("T")))
		{
			...
			{
				//mangio il re?
				if((state.getPawn(a.getRowTo()+1, a.getColumnTo()+1).equalsPawn("T")||(state.getPawn(a.getRowTo()+1, a.getColumnTo()+1).equalsPawn("B"))) && (state.getPawn(a.getRowTo()-1, a.getColumnTo()+1).equalsPawn("T")||state.getPawn(a.getRowTo()-1, a.getColumnTo()+1).equalsPawn("B")))
				{
					state.setTurn(State.Turn.BLACKWIN);
					//this.loggGame.fine("Nero vince con re catturato in: "+state.getBox(a.getRowTo(), a.getColumnTo()+1));
				}						
